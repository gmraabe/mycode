...
classmember_names = ['Micah', 'Kyle', 'Paul', 'Chris', 'Robert', 'Vivian', 'Dre', 'Homer', 'Josh', 'Nick', 'Eddie', 'Shawn']
print('\nclassmember_names looks like this:', classmember_names)
print('\nResults of sorted(classmember_names):', sorted(classmember_names))
print('Results of sorted(classmember_names, key=str.lower):', sorted(classmember_names, key=str.lower))
